 ...
 */
final class Version20221204154902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description MEDIUMTEXT NOT NULL, picture MEDIUMTEXT DEFAULT NULL, date_added DATETIME NOT NULL, date_update DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_23A0E662B36786B (title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
